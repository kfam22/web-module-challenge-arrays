...
// 2 parameters, array and string (for new flavor)
//  use unshift to add the new flavor to the beginning
// return the array
...
// use pop to remove the last item, then return array
...
// return array[number]
getFlavorByIndex(originalFlavors, 21);
...
*/
// 2 parameters: array, string we want to remove
...
// loop through the array and check each index for the exact match of string, it it exists, remove using splice
// .splice(start, how many itms to delete)
// outside of the loop, return the array
removeFlavorByName(originalFlavors,'Date Nut');
...
*/
// let abc = ['a', 'bb', 'cc', 'dd', 'e', 'ff', 'gg', 'hh', 'ii', 'jj'];
...
function getAverageWordLength(array){
  ...
  let lengthAvg = lengthSum/array.length;
  return lengthAvg;
}
